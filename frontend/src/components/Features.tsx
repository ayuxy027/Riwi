import { Bot, Zap, Shield, Link as LinkIcon, BarChart3, Rocket } from "lucide-react";
          ...
          {features.map((feature, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-14 h-14 bg-gray-50 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:bg-[#6E54FF] group-hover:text-white transition-all duration-300 shadow-sm relative z-10 text-[#6E54FF]">
