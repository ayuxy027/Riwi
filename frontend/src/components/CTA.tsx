        ...
        <div className="text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6 tracking-tight">
            <span className="bg-gradient-to-r from-rose-900 via-rose-800 to-pink-900 bg-clip-text text-transparent">
              Start earning for your feedback
            </span>
          </h2>
          <p className="text-xl text-rose-700 max-w-2xl mx-auto mb-10 leading-relaxed">
            Join the community of trusted reviewers on Monad. Share your experiences, earn rewards, and build your on-chain reputation.
          </p>
          ...
          <p className="text-sm text-rose-600">
            Instant rewards · High-performance platform · Verifiable trust
          </p>
        </div>
      </div>
    </section>
